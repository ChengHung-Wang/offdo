...
import "@/assets/style/stack-cards.css";
import { onMounted } from "vue";
import { useHomePageData } from "@/store/home-page-data";

onMounted(() => {
  /* eslint-disable */
  // Copy from: https://codyhouse.co/tutorials/how-stacking-cards
  // Utility function
  function Util() {
  }
...
<template>
  <main class="padding-y-xl" style="margin-top: 120px">

    <div class="container max-width-adaptive-md margin-bottom-lg">
      <ul class="stack-cards js-stack-cards p-0">
        <li v-for="(data, index) in (useHomePageData()).cases" :key="index"
            v-bind:class="{'bg-primary-color': index % 2 == 0, 'bg-secondary-color': index % 2 == 1}"
              ...
              <div class="col-sm-5">
                ...
                <div class="message mt-4">
                  <div class="avatar left"
                       v-bind:style="{backgroundImage: 'url(\'' + data.avatar.img + '\')'}"
